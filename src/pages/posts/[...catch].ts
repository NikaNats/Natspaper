...
export async function getStaticPaths() {
  // Return empty array - this handles dynamic requests at runtime
  // in development mode, and in production this route won't be needed
  // since the proper `/posts/slug` routes will be pre-generated
  return [];
}
